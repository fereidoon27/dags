...
Compatible with: Airflow 3.1.5, Python 3.12.8
"""
...
# Airflow 3.x SDK imports - NEW IMPORT PATTERN
from airflow.sdk.definitions.dag import dag
from airflow.sdk.definitions.decorators import task

# Airflow 3.x providers - sensors moved to providers-standard
from airflow.providers.standard.sensors.python import PythonSensor

# Exceptions remain in core
...
@dag(
    ...
    schedule=None,  # CHANGED: schedule_interval -> schedule (Airflow 3.x)
    catchup=False,
...
def card_processing_workflow():
    """
    Main DAG function defining the card processing workflow.
    
    Workflow Steps:
    1. Detect card files on FTP server (sensor)
    2. Get list of detected files
    3. Transfer files from FTP to target server
    4. Process files on target server
    """
    
    # Use PythonSensor from providers-standard
